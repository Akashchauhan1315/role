...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('/vendor/css/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('/vendor/css/prismjs.bundle.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="login-content flex-row-fluid d-flex flex-column p-10">
                    ...
                    <div class="d-flex flex-row-fluid flex-center">
                        ...
                        <div class="login-form">
                            <!--begin::Form-->
                            <form class="form" id="kt_login_singin_form" method="post" action="{{ route('login.store')}}">
                                <!--begin::Title-->
                                @csrf
                                <div class="pb-5 pb-lg-15">
                                    <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Sign In</h3>
                                    <div class="text-muted font-weight-bold font-size-h4">New Here? 
                                    <a href="{{ route('register.index')}}" class="text-primary font-weight-bolder">Create Account</a></div>
                                </div>
                                <!--begin::Title-->
                                <!--begin::Form group-->
                                ...
                                <div class="form-group">
                                    <div class="d-flex justify-content-between mt-n5">
                                        ...
                                        <a href="/metronic/demo1/custom/pages/login/login-3/forgot.html" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot Password ?</a>
                                    </div>
                                ...
                                <div class="pb-lg-0 pb-5">
                                    ...
                                    <span class="svg-icon svg-icon-md">
                                        <!--begin::Svg Icon | path:https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/svg/social-icons/google.svg-->
