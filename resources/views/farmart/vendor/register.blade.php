...
<html lang="en">
	...
	<head>
		...
		<link href="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/css/pages/login/login-3.css?v=7.2.8" rel="stylesheet" type="text/css" />
		...
		<link href="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/css/themes/layout/brand/dark.css?v=7.2.8" rel="stylesheet" type="text/css" />
		<link href="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/css/themes/layout/aside/dark.css?v=7.2.8" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="login-aside d-flex flex-column flex-row-auto">
					...
					<div class="d-flex flex-column-auto flex-column pt-15 px-30">
						...
						<a href="#" class="login-logo py-6">
							<img src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/logos/logo-1.png" class="max-h-70px" alt="" />
						</a>
						<!--end::Aside header-->
						<!--begin: Wizard Nav-->
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="aside-img-wizard d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center pt-2 pt-lg-5" style="background-position-y: calc(100% + 3rem); background-image: url(https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/svg/illustrations/features.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
				<div class="login-content flex-column-fluid d-flex flex-column p-10">
					...
					<div class="d-flex flex-row-fluid flex-center">
						...
						<div class="login-form login-form-signup">
							<!--begin::Form-->
							<form class="form" novalidate="novalidate" id="kt_login_signup_form" action="{{ route('register.store')}}" method="post">
								@csrf
								<!--begin: Wizard Step 1-->
								<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="pb-10 pb-lg-15">
										...
										<a href="{{ route('login.index')}}">Sign In</a></div>
									</div>
									<!--begin::Title-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">First Name</label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="name" placeholder="First Name" >
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Last Name</label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="lname" placeholder="Last Name">
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Phone</label>
										<input type="tel" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="phone" placeholder="phone">
									</div>
									<!--end::Form Group-->
								</div>
								<!--end: Wizard Step 1-->
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address1" placeholder="Address Line 1">
											</div>
											<!--end::Input-->
										</div>
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="address2" placeholder="Address Line 2">
											</div>
											<!--end::Input-->
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="postcode" placeholder="Postcode">
											</div>
											<!--end::Input-->
										</div>
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="city" placeholder="City">
											</div>
											<!--end::Input-->
										</div>
									</div>
									...
									<div class="row">
										<div class="col-xl-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="state" placeholder="State">
								...
								<div class="d-flex justify-content-between pt-3">
									<div class="mr-2">
										...
										<span class="svg-icon svg-icon-md mr-1">
											<!--begin::Svg Icon | path:https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/svg/icons/Navigation/Left-2.svg-->
									...
									<div>
										...
										<span class="svg-icon svg-icon-md ml-2">
											<!--begin::Svg Icon | path:https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/media/svg/icons/Navigation/Right-2.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
		...
		<script src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/plugins/global/plugins.bundle.js?v=7.2.8"></script>
		<script src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.2.8"></script>
		<script src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/js/scripts.bundle.js?v=7.2.8"></script>
		<script src="https://keenthemes.com/metronic/assets/js/engage_code.js"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="https://preview.keenthemes.com/metronic/theme/html/demo1/dist/assets/js/pages/custom/login/login-3.js?v=7.2.8"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>