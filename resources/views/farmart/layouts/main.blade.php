...
<head>
    @include('farmart.layouts.head')
</head>

<body>
    <header class="header">
        @include('farmart.layouts.head-bar')
        <div class="ps-header--center header--mobile">
            <div class="container">
                <div class="header-inner">
                    ...
                    <div class="header-inner__center"><a class="logo open" href="{{ route('index')}}">Farm<span class="text-black">art.</span></a></div>
        ...
        @include('farmart.layouts.header-section')
        @include('farmart.layouts.header-nav')
    ...
    @include('farmart.layouts.footer')
</body>
