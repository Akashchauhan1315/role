                    ...
                    <div class="login__content">
                        ...
                        <form method="post">
                            ...
                            <div class="input-group">
                                <input class="form-control @error('email') is-invalid @enderror" type="email" placeholder="Username/ Email" name="email">
                                @error('email')
                            ...
                            <div class="input-group group-password">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <!-- <i class="fa fa-eye btn forgot-pas" aria-hidden="true"></i> -->
                                </div>
                            </div>
                            @error('password')
                            <div class="invalid-feedback error-block">{{ $message }}</div>
